...
-spec is_inflation(ext_type_aggresult_intermediate(), ext_type_aggresult_intermediate()) -> boolean().
is_inflation(
    {?TYPE, {intermediate, AllPathInfoList, ORSetBaseL}=_AggResultORSetPayloadL},
    {?TYPE, {intermediate, AllPathInfoList, ORSetBaseR}=_AggResultORSetPayloadR}) ->
...
-spec is_strict_inflation(ext_type_aggresult_intermediate(), ext_type_aggresult_intermediate()) ->
    boolean().
is_strict_inflation(
    {?TYPE, {intermediate, AllPathInfoList, ORSetBaseL}=_AggResultORSetPayloadL},
    {?TYPE, {intermediate, AllPathInfoList, ORSetBaseR}=_AggResultORSetPayloadR}) ->
