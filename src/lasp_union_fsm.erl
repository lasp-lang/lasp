...
start_link(ReqId, From, Left, Right, Union) ->
    gen_fsm:start_link(?MODULE, [ReqId, From, Left, Right, Union], []).
...
init([ReqId, From, Left, Right, Union]) ->
...
execute(timeout, #state{preflist=Preflist,
    ...
    lasp_vnode:union(Preflist, {ReqId, Coordinator}, Left, Right, Union),
