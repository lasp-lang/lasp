...
start_link(ReqId, From, Id, Threshold) ->
    gen_fsm:start_link(?MODULE, [ReqId, From, Id, Threshold], []).
...
execute(timeout, #state{preflist=Preflist,
    ...
    lasp_vnode:wait_needed(Preflist, {ReqId, Coordinator}, Id, Threshold),
